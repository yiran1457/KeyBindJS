...
public class KeyBindModifyEvent extends EventJS {
    ...
    public void modifyModifier(String keyBindName,KeyModifier keyModifier) { modifyListModifier.put(keyBindName,keyModifier); }
    public void modifyCategory(String keyBindName,String category) {
        modifyListCategory.put(keyBindName,category);
    }
    public void remove(String keyBindName) { removeList.add(keyBindName); }
