...
@EventBusSubscriber(value = Dist.CLIENT, bus = EventBusSubscriber.Bus.MOD, modid = Keybindjs.MODID)
public class KeyBindModifyEvent implements ClientKubeEvent {
    ...
    private static final Path VSCODE_PATH = FMLPaths.GAMEDIR.get().normalize().toAbsolutePath().resolve(".vscode");
